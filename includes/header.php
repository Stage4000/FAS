...
<head>
    ...
    <meta property="og:image" content="<?php echo isset($ogImage) ? $ogImage : 'https://' . ($_SERVER['HTTP_HOST'] ?? 'flipandstrip.com') . '/gallery/aaron-huber-KxeFuXta4SE-unsplash-ts1669126250.jpg'; ?>">
    ...
    <meta property="twitter:image" content="<?php echo isset($ogImage) ? $ogImage : 'https://' . ($_SERVER['HTTP_HOST'] ?? 'flipandstrip.com') . '/gallery/aaron-huber-KxeFuXta4SE-unsplash-ts1669126250.jpg'; ?>">
