...
// Build SQL filter for eBay categories
$categoryFilter = null;
if ($ebayCat3) {
    // Filter by specific level 3 category
    $categoryFilter = ['ebay_store_cat3_id' => $ebayCat3];
} elseif ($ebayCat2) {
    // Filter by level 2 category (all products in this manufacturer)
    $categoryFilter = ['ebay_store_cat2_id' => $ebayCat2];
} elseif ($ebayCat1) {
    // Filter by level 1 category (all products in this top-level category)
    $categoryFilter = ['ebay_store_cat1_id' => $ebayCat1];
}
